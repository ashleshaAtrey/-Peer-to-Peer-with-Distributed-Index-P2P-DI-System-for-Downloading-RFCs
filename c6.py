...
def bestcase(ServHost):			#decentralized
		...
		global list1	
		count=0
		listbest=[["127.0.0.2",65402,0],["127.0.0.3",65403,1],["127.0.0.4",65404,2],["127.0.0.5",65405,3],["127.0.0.6",65406,4]]	
...
def menu(ServPort,ServHost):
	global list1
	j=1
	clientHost,clientPort="127.0.0.7",65413
	while (True):
	    ...
	    print "9 Task 2 Decentralized worstcase"                                 #First register, and pquery
	    print "10 Task 2 Decentralized bestcase"                                 #First register, and pquery
...
def main():
	...
	timez=0
	list1=[]
    	ServHost,ServPort="127.0.0.7",65407
